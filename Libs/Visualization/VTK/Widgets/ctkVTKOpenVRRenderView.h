...
#ifndef __ctkVTKOpenVRRenderView_h
#define __ctkVTKOpenVRRenderView_h

// CTK includes
#include <ctkAxesWidget.h>
#include "ctkVTKOpenVRAbstractView.h"
class ctkVTKOpenVRRenderViewPrivate;

class vtkCamera;
class vtkOpenVRRenderer;

/// \ingroup Visualization_VTK_Widgets
class CTK_VISUALIZATION_VTK_WIDGETS_EXPORT ctkVTKOpenVRRenderView : public ctkVTKOpenVRAbstractView
{
  Q_OBJECT
...
public:
  ...
  typedef ctkVTKOpenVRAbstractView Superclass;
  explicit ctkVTKOpenVRRenderView(QWidget* parent = 0);
  virtual ~ctkVTKOpenVRRenderView();
...
public:
  ...
  virtual void setInteractor(vtkOpenVRRenderWindowInteractor* interactor);
...
private:
  Q_DECLARE_PRIVATE(ctkVTKOpenVRRenderView);
  Q_DISABLE_COPY(ctkVTKOpenVRRenderView);
};
