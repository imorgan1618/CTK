...
#ifndef __ctkVTKOpenVRAbstractView_h
#define __ctkVTKOpenVRAbstractView_h
...
class ctkVTKOpenVRAbstractViewPrivate;
...
class CTK_VISUALIZATION_VTK_WIDGETS_EXPORT ctkVTKOpenVRAbstractView : public QWidget
{
  Q_OBJECT
  QVTK_OBJECT
...
public:
  ...
  explicit ctkVTKOpenVRAbstractView(QWidget* parent = 0);
  virtual ~ctkVTKOpenVRAbstractView();
...
protected:
  QScopedPointer<ctkVTKOpenVRAbstractViewPrivate> d_ptr;
  ctkVTKOpenVRAbstractView(ctkVTKOpenVRAbstractViewPrivate* pimpl, QWidget* parent);

private:
  Q_DECLARE_PRIVATE(ctkVTKOpenVRAbstractView);
  Q_DISABLE_COPY(ctkVTKOpenVRAbstractView);
};
